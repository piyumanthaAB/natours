        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              location.assign('/'); // location.reload(); // reload the page from server. not from the browser cache.
            } // location.reload();
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error in logging out');
...
var stripe = Stripe('pk_test_51IRH5jHZ6F3OU2lGSb6k80epbvtYowr6MrVDtGHNLTgGEOmlSGVhAm38e52tQwxJhHCK71X7uFm8hqfzyCql1wIf00QWV5CWug');
...
var formUpdateDetails = document.querySelector('.form-user-data');
var formUpdatePassword = document.querySelector('.form-user-password');
...
if (formUpdateDetails) {
  formUpdateDetails.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.save-button-form').textContent = 'Saving....'; // this equals to creating the form

              form = new FormData();
              form.append('name', document.getElementById('name').value);
              form.append('email', document.getElementById('email').value);
              form.append('photo', document.getElementById('photo').files[0]); // console.log(email,name);
...
if (formUpdatePassword) {
  formUpdatePassword.addEventListener('submit', /*#__PURE__*/function () {
